...
const InventoryControl: React.FC<Props> = ({ visible, onClose }) => {
  ...
  return (
      <div className="inventory-control">
        <button className="control-close" type="button" onClick={onClose} aria-label="Close controls">
          x
        </button>
        <div className="inventory-control-wrapper">
          <span className="control-title">Item actions</span>
          <input
