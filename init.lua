...
-- Extended systems (equipment slots, clothing, physics drops, frisk, holding)
shared.custom = data('custom') or {}

if shared.custom.equipment and shared.custom.equipment.enabled then
    -- Equipment slots are appended after the regular slots; the UI renders
    -- everything past equipmentBaseSlot in the equipment/clothing panels.
    shared.equipmentBaseSlot = shared.playerslots
    shared.playerslots += #shared.custom.equipment.slots
end
